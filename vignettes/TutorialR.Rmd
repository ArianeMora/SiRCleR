...
write.csv(rcm_df[, c(geneId, methSamples$FullLabel)], 'CPTAC_cpg_S4.csv')
write.csv(rcm_df[, c(geneId, rnaSamples$FullLabel)], 'CPTAC_RNA_S4.csv')
write.csv(rcm_df[, c(geneId, proteinSamples$FullLabel)], 'CPTAC_protein_S4.csv')
